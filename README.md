...
[![Build](https://github.com/GuicedEE/Rest-Client/actions/workflows/build.yml/badge.svg)](https://github.com/GuicedEE/Rest-Client/actions/workflows/build.yml)
[![Maven Central](https://img.shields.io/maven-central/v/com.guicedee/rest-client)](https://github.com/GuicedEE/Rest-Client)
...
```kotlin
implementation("com.guicedee:rest-client:2.0.1-SNAPSHOT")
```
</details>
